...
namespace Assets.LSL4Unity.Scripts
{
    ...
    {
        private const string unique_source_id_suffix = "Position_123";
        ...
        public string StreamName = "Position_Orientation";
        ...
        void Start()
        {
            gameObj = GameObject.Find("LSL_Functions");
            carposCheck = gameObj.GetComponent<Menu_LSL>().CarPosition;
